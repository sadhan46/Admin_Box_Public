import 'package:cash_drop/Screens/CustomerCatalog.dart';
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => Pay(businessName: widget.businessName,image: 'image',firstName: widget.firstName,lastName: widget.lastName,),
                      ),);
                    },
                    child: Center(
                      child: Text('Pay',
              ...
              Container(
                child: Center(
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => CustomerCatalog(businessName: widget.businessName),
                      ),);
                    },
                    child: Center(
                      child: Text('Catalog',
