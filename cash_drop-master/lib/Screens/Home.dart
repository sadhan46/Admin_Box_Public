...
import 'package:cash_drop/FIrebase/CustomerService.dart';
...
import 'package:cash_drop/Screens/ScanQR.dart';
import 'package:cash_drop/Screens/Search.dart';
    ...
    return Drawer(
      child: Column(
        children: [
          ...
          ListTile(
            leading: Icon(Icons.business_rounded,color: primaryColor,size: 33,),
            title: Text('Business',
                style: GoogleFonts.poppins(
                    fontWeight: FontWeight.w400,
                    fontSize: 22,
          ...
          ListTile(
            leading: Icon(Icons.people_rounded,color: primaryColor,size: 33,),
            title: Text('Customer',
                style: GoogleFonts.poppins(
                    fontWeight: FontWeight.w400,
                    fontSize: 22,
