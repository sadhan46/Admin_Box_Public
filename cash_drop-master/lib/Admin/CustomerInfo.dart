...
class CustomerInfo extends StatefulWidget {
  ...
  CustomerInfo({ Key? key,required this.username, required this.cart,required this.totalCost,required this.totalHr,required this.totalMin}) : super(key: key);
